...
from ldm.modules.attention import SpatialTransformer, CrossAttention, GatedCrossAttentionDense
...
class UNetModel(nn.Module):
    def __init__(
        ...
        self.cross_objs_context = GatedCrossAttentionDense(query_dim=context_dim, key_dim=context_dim, value_dim=context_dim, n_heads=num_heads, d_head=context_dim//num_heads)
    ...
    def forward(self, input):
        ...
        # Text input 
        context = input["context"].float()
        objs = self.cross_objs_context(objs, context)
