...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77):
        ...
        # /home/wangzeyu/.cache/huggingface/transformers/
        # self.tokenizer = CLIPTokenizer.from_pretrained("/home/wangzeyu/.cache/huggingface/transformers/clip-vit-large-patch14") # wzy
        # self.transformer = CLIPTextModel.from_pretrained("/home/wangzeyu/.cache/huggingface/transformers/clip-vit-large-patch14") # wzy
        self.device = device
        self.max_length = max_length
        self.freeze()
...
class FrozenLongCLIPEmbedder(AbstractEncoder):
    """Uses the LongCLIP transformer encoder for text (from Hugging Face)"""
    def __init__(self, device="cuda", max_length=77):
        super().__init__()
        self.device = device
        self.model, self.preprocess = longclip.load("./ldm/modules/encoders/long_clip/checkpoints/longclip-L.pt", device=device)
        self.freeze()
    ...
    def forward(self, text, return_pooler_output=False):
        ...
        z, z_proj = self.model.encode_text(text)
